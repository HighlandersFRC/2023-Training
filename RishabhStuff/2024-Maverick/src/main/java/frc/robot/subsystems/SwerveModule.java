...
public class SwerveModule extends SubsystemBase {
  ...
  PositionTorqueCurrentFOC positionTorqueFOCRequest = new PositionTorqueCurrentFOC(0, 0, 0, 0, false);
  VelocityTorqueCurrentFOC velocityTorqueFOCRequest = new VelocityTorqueCurrentFOC(0, 0, 0, 0, false);
  VelocityTorqueCurrentFOC velocityTorqueFOCRequestAngleMotor = new VelocityTorqueCurrentFOC(0, 0, 0, 1, false);
  VelocityTorqueCurrentFOC velocityTorqueFOCRequestDriveMotor = new VelocityTorqueCurrentFOC(0, 0, 0, 1, false);

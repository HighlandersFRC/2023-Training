...
public class Peripherals extends SubsystemBase {
  ...
  public double getYawVelocityDeviceCentric(){
    return pigeon.getAngularVelocityZDevice().getValue();
  }

  public double getPitchVelocityDeviceCentric(){
    return pigeon.getAngularVelocityYDevice().getValue();
  }

  public double getRollVelocityDeviceCentric(){
    return pigeon.getAngularVelocityXDevice().getValue();
  }

  public double getYawVelocityWorldCentric(){
    return pigeon.getAngularVelocityZWorld().getValue();
  }

  public double getPitchVelocityWorldCentric(){
    return pigeon.getAngularVelocityYWorld().getValue();
  }

  public double getRollVelocityWorldCentric(){

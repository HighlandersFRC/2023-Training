...
import frc.robot.commands.ToggleWings;
import frc.robot.commands.WingsDown;
...
public class Robot extends TimedRobot {
  ...
  private final WingSubsystem wings = new WingSubsystem();
  ...
  public void teleopInit() {
    ...
    wings.init();
    //tail.init();
    //OI.rightTrigger.whenPressed(new IntakeBalls(intake));
    //OI.leftTrigger.whenPressed(new OutakeBalls(intake));
